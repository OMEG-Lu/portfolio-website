      ...
      <div className="px-[51px] py-[48px] min-h-[488px] flex flex-col justify-between">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[48px]">
          ...
          <div>
            ...
            <a
              href="mailto:jack1125516912@outlook.com"
              className="block mt-[16px] text-[14px] text-black/70 hover:text-black transition-colors"
            >
              jack1125516912@outlook.com
            </a>
            <a
              href="tel:+12675828640"
              className="block mt-[8px] text-[14px] text-black/70 hover:text-black transition-colors"
            >
              +1 (267) 582-8640
            </a>
          </div>
